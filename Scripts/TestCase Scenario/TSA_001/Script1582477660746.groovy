...
WebUI.callTestCase(findTestCase('TestCase Activity/Provisioning'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('TestCase Activity/Dashboard'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('TestCase Activity/Location'), [:], FailureHandling.STOP_ON_FAILURE)
